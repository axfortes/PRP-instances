...
std::vector<int> prts (6,0); //perturbations
...
double oils(data d){
    ...
    std::uniform_int_distribution<> PT(1,5);
    ...
    do{
        ...
        //tipo: (1) inversão de rota, (2) divisao de rota, (3) swap(k,k), (4) lexicografica, (5) randomica
        std::vector<int> success (6,1);
        success[0] = 5;
    ...
    std::cout << " >>";
    //quantidade total de perturbacoes e quantidades individuais
    for (int nt = 0; nt <= d.ntMax; nt++) std::cout << " " << iPN[nt];
    std::cout << " >>";
    for (int ls = 0; ls <= 5; ls++) std::cout << " " << prts[ls];    
...
int main(int argc, char *argv[]){        
    ...
    d.pathOut = "/home/varatan/Documentos/Dropbox/02-ufmg/02-doutorado/01-pesquisa/02-tese/03-implementacoes/02-prp/04-prp-v-indx-h/00-outputs/01-bu/01/";
